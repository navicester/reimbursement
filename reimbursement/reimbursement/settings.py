"""
Django settings for reimbursement project.
...
SECRET_KEY = '*vlqp@o2x&f1oig^xu*n^^xif%43#*mqbew7$5667ksd9rrlam'
...
ROOT_URLCONF = 'reimbursement.urls'
...
WSGI_APPLICATION = 'reimbursement.wsgi.application'
